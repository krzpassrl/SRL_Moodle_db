...
/**
 * The mod_setask statement accepted event.
 *
 * @package    mod_setask
...
/**
 * The mod_setask statement accepted event class.
 *
 * @package    mod_setask
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class statement_accepted extends base {
    ...
    public static function get_name() {
        return get_string('eventstatementaccepted', 'mod_setask');
    }
    ...
    protected function get_legacy_logdata() {
        global $USER;
        $logmessage = get_string('submissionstatementacceptedlog', 'mod_setask', fullname($USER)); // Nasty hack.
