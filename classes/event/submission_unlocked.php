...
/**
 * The mod_setask submission unlocked event.
 *
 * @package    mod_setask
...
/**
 * The mod_setask submission unlocked event class.
 *
 * @package    mod_setask
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_unlocked extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionunlocked', 'mod_setask');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('unlocksubmissionforstudent', 'setask', array('id' => $user->id, 'fullname' => fullname($user)));
