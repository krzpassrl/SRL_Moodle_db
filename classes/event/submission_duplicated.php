...
/**
 * The mod_setask submission duplicated event.
 *
 * @package    mod_setask
...
/**
 * The mod_setask submission duplicated event class.
 *
 * @package    mod_setask
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_duplicated extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionduplicated', 'mod_setask');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $this->set_legacy_logdata('submissioncopied', $this->setask->format_submission_for_log($submission));
