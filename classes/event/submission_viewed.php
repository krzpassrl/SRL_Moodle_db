...
/**
 * The mod_setask submission viewed event.
 *
 * @package    mod_setask
...
/**
 * The mod_setask submission viewed event class.
 *
...
class submission_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionviewed', 'mod_setask');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewsubmissionforuser', 'setask', $this->relateduserid);
