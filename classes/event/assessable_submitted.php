...
/**
 * The mod_setask assessable submitted event.
 *
 * @package    mod_setask
...
/**
 * The mod_setask assessable submitted event class.
 *
...
class assessable_submitted extends base {
    ...
    public static function get_name() {
        return get_string('eventassessablesubmitted', 'mod_setask');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $this->set_legacy_logdata('submit for grading', $this->setask->format_submission_for_log($submission));
