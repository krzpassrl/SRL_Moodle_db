...
/**
 * The mod_setask batch set marker allocation viewed event.
 *
 * @package    mod_setask
...
/**
 * The mod_setask batch set marker allocation viewed event class.
 *
...
class batch_set_marker_allocation_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventbatchsetmarkerallocationviewed', 'mod_setask');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the batch set marker allocation for the setaskment with course " .
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewbatchmarkingallocation', 'setask');
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call batch_set_marker_allocation_viewed::create() directly, use batch_set_marker_allocation_viewed::create_from_setask() instead.');
        }
