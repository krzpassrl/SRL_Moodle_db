...
/**
 * The mod_setask submission graded event.
 *
 * @package    mod_setask
...
/**
 * The mod_setask submission graded event class.
 *
 * @package    mod_setask
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_graded extends base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has graded the submission '$this->objectid' for the user with " .
            "id '$this->relateduserid' for the setaskment with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventsubmissiongraded', 'mod_setask');
    }
    ...
    protected function get_legacy_logdata() {
        $grade = $this->get_record_snapshot('setask_grades', $this->objectid);
        $this->set_legacy_logdata('grade submission', $this->setask->format_grade_for_log($grade));
