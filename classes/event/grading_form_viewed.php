...
/**
 * The mod_setask grading form viewed event.
 *
 * @package    mod_setask
...
/**
 * The mod_setask grading form viewed event class.
 *
...
class grading_form_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventgradingformviewed', 'mod_setask');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $msg = get_string('viewgradingformforstudent', 'setask',
