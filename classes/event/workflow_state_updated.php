...
/**
 * mod_setask workflow state updated event.
 *
 * @package    mod_setask
...
/**
 * mod_setask workflow state updated event class.
 *
...
class workflow_state_updated extends base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has set the workflow state of the user with id '$this->relateduserid' " .
            "to the state '{$this->other['newstate']}' for the setaskment with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventworkflowstateupdated', 'mod_setask');
    }
