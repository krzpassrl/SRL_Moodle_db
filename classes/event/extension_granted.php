...
/**
 * The mod_setask extension granted event.
 *
 * @package    mod_setask
...
/**
 * The mod_setask extension granted event class.
 *
 * @package    mod_setask
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class extension_granted extends base {
     ...
     */
    public static function create_from_setask(\setask $setask, $userid) {
        $data = array(
    ...
    public static function get_name() {
        return get_string('eventextensiongranted', 'mod_setask');
    }
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call extension_granted::create() directly, use extension_granted::create_from_setask() instead.');
        }
