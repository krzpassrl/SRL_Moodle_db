...
require_once($CFG->dirroot.'/mod/setask/setaskmentplugin.php');

/**
 * Abstract class for feedback_plugin inherited from setask_plugin abstract class.
 *
 * @package   mod_setask
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class setask_feedback_plugin extends setask_plugin {
     ...
     *
     * A grading action is a page that is not specific to a user but to the whole setaskment.
     * @return array - An array of action and description strings.
