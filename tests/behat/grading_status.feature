@mod @mod_setask
Feature: View the grading status of an setaskment
  In order to test the grading status for setaskments is displaying correctly
  As a student
  ...
  @javascript
  Scenario: View the grading status for an setaskment with marking workflow enabled
    # Add the setaskment.
    ...
    # The grade should also remain displayed as it's stored in the setask DB tables, but the final grade should be empty.
    And "Student 1" row "Grade" column of "generaltable" table should contain "50.00"
    And "Student 1" row "Final grade" column of "generaltable" table should contain "-"
    And I log out

  @javascript
  Scenario: View the grading status for an setaskment with marking workflow disabled
    # Add the setaskment.
    And I log in as "teacher1"
    And I follow "Course 1"
    And I turn editing mode on
