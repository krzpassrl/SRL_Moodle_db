...
/**
 * Base class for unit tests for mod_setask.
 *
 * @package    mod_setask
 * @category   phpunit
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_setask_base_testcase extends advanced_testcase {
    ...
    /** @var stdClass $course New course created to hold the setaskments */
    ...
    /**
     * Setup function - we will create a course and add an setask instance to it.
     */
    ...
    /**
     * Convenience function to create a testable instance of an setaskment.
     *
     * @param array $params Array of parameters to pass to the generator
     * @return testable_setask Testable wrapper around the setask class.
     */
    protected function create_instance($params=array()) {
        ...
        return new testable_setask($context, $cm, $this->course);
    }
 ...
 */
class testable_setask extends setask {
    ...
    public function testable_process_set_batch_marking_allocation($selectedusers, $markerid) {
        ...
        mod_setask_batch_set_allocatedmarker_form::mock_submit($data);
    ...
    public function testable_process_set_batch_marking_workflow_state($selectedusers, $state) {
        ...
        mod_setask_batch_set_marking_workflow_state_form::mock_submit($data);
