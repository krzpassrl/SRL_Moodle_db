 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_setask_grade_form extends moodleform {
    /** @var setaskment $setaskment */
    private $setaskment;
    ...
    public function definition() {
        ...
        list($setaskment, $data, $params) = $this->_customdata;
        // Visible elements.
        $this->setaskment = $setaskment;
        $setaskment->add_grade_form_elements($mform, $data, $params);
