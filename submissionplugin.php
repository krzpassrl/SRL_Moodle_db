 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class setask_submission_plugin extends setask_plugin {
     ...
     * @param stdClass $submission the setask_submission record being submitted.
     ...
     *
     * @param stdClass|false $submission - setask_submission data if any
     ...
     *
     * @param stdClass $submission - setask_submission data
     * @return void
     */
