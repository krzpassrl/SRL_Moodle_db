...
/**
 * This file contains the definition for the renderable classes for the setaskment
 *
 * @package   mod_setask
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_submit_for_grading_page implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_gradingmessage implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_form implements renderable {
    /** @var moodleform $form is the edit submission form */
    public $form = null;
    /** @var string $classname is the name of the class to setask to the container */
    public $classname = '';
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_user_summary implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_feedback_plugin_feedback implements renderable {
    /** @var int SUMMARY */
    const SUMMARY                = 10;
    /** @var int FULL */
    const FULL                   = 20;

    /** @var setask_submission_plugin $plugin */
    public $plugin = null;
    /** @var stdClass $grade */
    public $grade = null;
    /** @var string $view */
     ...
     *
     * @param setask_feedback_plugin $plugin
     ...
     */
    public function __construct(setask_feedback_plugin $plugin,
                                stdClass $grade,
                                $view,
                                $coursemoduleid,
                                $returnaction,
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_submission_plugin_submission implements renderable {
    /** @var int SUMMARY */
    const SUMMARY                = 10;
    /** @var int FULL */
    const FULL                   = 20;
    ...
    /**
     * Constructor
     * @param setask_submission_plugin $plugin
     ...
     */
    public function __construct(setask_submission_plugin $plugin,
                                stdClass $submission,
                                $view,
                                $coursemoduleid,
                                $returnaction,
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_feedback_status implements renderable {
    ...
    /** @var stdClass setask_grade record */
    public $grade = null;
    /** @var int coursemoduleid */
    public $coursemoduleid = 0;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_submission_status implements renderable {
...
/**
 * Used to output the attempt history for a particular setaskment.
 *
 * @package mod_setask
 * @copyright 2012 Davo Smith, Synergy Learning
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_attempt_history implements renderable {
    ...
    public $feedbackplugins = array();
    /** @var int coursemoduleid - The cmid for the setaskment */
    public $coursemoduleid = 0;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_header implements renderable {
    /** @var stdClass the setask record  */
    public $setask = null;
     ...
     * Constructor
     *
     * @param stdClass $setask  - the setask database record
     ...
     */
    public function __construct(stdClass $setask,
                                $context,
                                $showintro,
                                $coursemoduleid,
                                $subpage='',
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_plugin_header implements renderable {
    /** @var setask_plugin $plugin */
    public $plugin = null;

    /**
     * Header for a single plugin
     *
     * @param setask_plugin $plugin
     */
    public function __construct(setask_plugin $plugin) {
        $this->plugin = $plugin;
    }
}
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_grading_summary implements renderable {
    /** @var int participantcount - The number of users who can submit to this setaskment */
    ...
    /** @var int duedate - The setaskment due date (if one is set) */
    public $duedate = 0;
    /** @var int cutoffdate - The setaskment cut off date (if one is set) */
    public $cutoffdate = 0;
    /** @var int coursemoduleid - The setaskment course module id */
    public $coursemoduleid = 0;
    /** @var boolean teamsubmission - Are team submissions enabled for this setaskment */
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_course_index_summary implements renderable {
    /** @var array setaskments - A list of course module info and submission counts or statuses */
    public $setaskments = array();
     ...
     * @param int $timedue - The due date for the setaskment - may be 0 if no duedate
     * @param string $submissioninfo - A string with either the number of submitted setaskments, or the
     ...
     */
    public function add_setask_info($cmid, $cmname, $sectionname, $timedue, $submissioninfo, $gradeinfo) {
        $this->setaskments[] = array('cmid'=>$cmid,
                               'cmname'=>$cmname,
...
/**
 * An setask file class that extends rendererable class and is used by the setask module.
 *
 * @package   mod_setask
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setask_files implements renderable {
    /** @var context $context */
    public $context;
    /** @var string $context */
    public $dir;
    ...
    public function __construct(context $context, $sid, $filearea, $component) {
        ...
        if (!empty($CFG->enableportfolios)) {
            ...
            if (count($files) >= 1 &&
                    has_capability('mod/setask:exportownsubmission', $this->context)) {
                $button = new portfolio_add_button();
                $callbackparams = array('cmid' => $this->cm->id,
                                        'sid' => $sid,
                                        'area' => $filearea,
                                        'component' => $component);
                $button->set_callback_options('setask_portfolio_caller',
                                              $callbackparams,
                                              'mod_setask');
    ...
    public function preprocess($dir, $filearea, $component) {
        ...
        foreach ($dir['files'] as $file) {
            ...
            if (!empty($CFG->enableportfolios)) {
                $button = new portfolio_add_button();
                if (has_capability('mod/setask:exportownsubmission', $this->context)) {
