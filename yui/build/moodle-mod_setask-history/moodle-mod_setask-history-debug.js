YUI.add('moodle-mod_setask-history', function (Y, NAME) {

// Define a function that will run in the context of a
// Node instance:
var CSS = {
        LINK: 'mod-setask-history-link',
        OPEN: 'mod-setask-history-link-open',
        CLOSED: 'mod-setask-history-link-closed',
        PANEL: 'mod-setask-history-panel'
    },
    COUNT = 0,
    TOGGLE = function() {
        var id = this.get('for'),
