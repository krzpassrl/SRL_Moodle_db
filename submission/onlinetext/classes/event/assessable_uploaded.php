...
/**
 * The setasksubmission_onlinetext assessable uploaded event.
 *
...
namespace setasksubmission_onlinetext\event;

defined('MOODLE_INTERNAL') || die();

/**
 * The setasksubmission_onlinetext assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'setasksubmission_onlinetext');
    }
