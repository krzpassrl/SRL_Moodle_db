 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setaskfeedback_file_batch_upload_files_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'batchuploadfilesforusers', get_string('batchuploadfilesforusers', 'setaskfeedback_file',
            count($params['users'])));
