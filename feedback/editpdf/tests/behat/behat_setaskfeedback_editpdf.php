 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_setaskfeedback_editpdf extends behat_base {
    ...
    public function ghostscript_is_installed() {
        $testpath = setaskfeedback_editpdf\pdf::test_gs_path();
        if (!extension_loaded('zlib') or
            $testpath->status !== setaskfeedback_editpdf\pdf::GSPATH_OK) {
