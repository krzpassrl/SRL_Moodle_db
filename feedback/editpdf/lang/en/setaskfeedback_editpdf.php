...
/**
 * Strings for component 'setaskfeedback_editpdf', language 'en'
 *
...
$string['enabled_help'] = 'If enabled, the teacher will be able to create annotated PDF files when marking the setaskments. This allows the teacher to add comments, drawing and stamps directly on top of the students work. The annotating is done in the browser and no extra software is required.';
