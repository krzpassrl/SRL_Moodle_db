 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setaskfeedback_editpdf_widget implements renderable {

    /** @var int $setaskment - Assignment instance id */
    public $setaskment = 0;
    ...
    /**
     * Constructor
     * @param int $setaskment - Assignment instance id
     ...
     */
    public function __construct($setaskment, $userid, $attemptnumber, $downloadurl,
