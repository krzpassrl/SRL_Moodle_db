 ...
 * @return bool
 */
function xmldb_setaskfeedback_editpdf_upgrade($oldversion) {
    global $CFG;
    ...
    if ($oldversion < 2013110800) {
        ...
        $fs = get_file_storage();
        $stamps = $fs->get_area_files(context_system::instance()->id, 'setaskfeedback_editpdf',
        ...
        if (empty($stamps)) {
            ...
            $filerecord->component = 'setaskfeedback_editpdf';
            ...
            foreach ($defaultstamps as $stamp) {
                ...
                $fs->create_file_from_pathname($filerecord,
                    $CFG->dirroot . '/mod/setask/feedback/editpdf/pix/' . $filerecord->filename);
            }
        }

        upgrade_plugin_savepoint(true, 2013110800, 'setaskfeedback', 'editpdf');
    }
