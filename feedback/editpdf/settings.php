...
/**
 * Settings for setaskfeedback PDF plugin
 *
...
// Stamp files setting.
$name = 'setaskfeedback_editpdf/stamps';
$title = get_string('stamps','setaskfeedback_editpdf');
$description = get_string('stampsdesc', 'setaskfeedback_editpdf');
...
$settings->add(new admin_setting_heading('pathtogs', get_string('pathtogs', 'admin'),
        get_string('pathtogspathdesc', 'setaskfeedback_editpdf', $systempathlink)));

$url = new moodle_url('/mod/setask/feedback/editpdf/testgs.php');
$link = html_writer::link($url, get_string('testgs', 'setaskfeedback_editpdf'));
