YUI.add('moodle-setaskfeedback_editpdf-editor', function (Y, NAME) {
 ...
 */
var AJAXBASE = M.cfg.wwwroot + '/mod/setask/feedback/editpdf/ajax.php',
    AJAXBASEPROGRESS = M.cfg.wwwroot + '/mod/setask/feedback/editpdf/ajax_progress.php',
    CSS = {
        DIALOGUE : 'setaskfeedback_editpdf_widget'
    },
    SELECTOR = {
        ...
        SEARCHFILTER : '.setaskfeedback_editpdf_commentsearch input',
        SEARCHCOMMENTSLIST : '.setaskfeedback_editpdf_commentsearch ul',
        ...
        UNSAVEDCHANGESDIV : '.setaskfeedback_editpdf_unsavedchanges',
...
var POINT = function(x, y) {
     ...
     * @method clip
     * @param M.setaskfeedback_editpdf.point
     * @public
     */
...
M.setaskfeedback_editpdf.point = POINT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.rect = RECT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
 ...
 *
 * @namespace M.setaskfeedback_editpdf
 * @param M.setaskfeedback_editpdf.editor editor
 * @class drawable
 */
var DRAWABLE = function(editor) {

    /**
     * Reference to M.setaskfeedback_editpdf.editor.
     * @property editor
     * @type M.setaskfeedback_editpdf.editor
     * @public
     */
    this.editor = editor;
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.drawable = DRAWABLE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATION, Y.Base, {
    ...
    /**
     * Reference to M.setaskfeedback_editpdf.drawable
     * @property drawable
     * @type M.setaskfeedback_editpdf.drawable
     * @public
     */
    drawable : false,
     ...
     * @return M.setaskfeedback_editpdf.drawable
     */
    draw_highlight : function() {
        ...
        if (this.editor.currentannotation === this) {
            ...
            bounds = new M.setaskfeedback_editpdf.rect();
            bounds.bound([new M.setaskfeedback_editpdf.point(this.x, this.y),
                          new M.setaskfeedback_editpdf.point(this.endx, this.endy)]);
            ...
            var deleteicon = Y.Node.create('<img src="' + M.util.image_url('trash', 'setaskfeedback_editpdf') + '"/>'),
                deletelink = Y.Node.create('<a href="#" role="button"></a>');

            deleteicon.setAttrs({
                'alt': M.util.get_string('deleteannotation', 'setaskfeedback_editpdf')
            });
     ...
     * @public
     * @method draw
     * @return M.setaskfeedback_editpdf.drawable|false
     */
    draw : function() {
     ...
     * @param M.setaskfeedback_editpdf.edit edit
     */
    ...
    init_from_edit : function(edit) {
        var bounds = new M.setaskfeedback_editpdf.rect();
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.annotation = ANNOTATION;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
 ...
 * @extends M.setaskfeedback_editpdf.annotation
 */
...
Y.extend(ANNOTATIONLINE, M.setaskfeedback_editpdf.annotation, {
    /**
    ...
    draw : function() {
        ...
        drawable = new M.setaskfeedback_editpdf.drawable(this.editor);
     ...
     */
    draw_current_edit : function(edit) {
        var drawable = new M.setaskfeedback_editpdf.drawable(this.editor),
            shape;
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.annotationline = ANNOTATIONLINE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONRECTANGLE, M.setaskfeedback_editpdf.annotation, {
    /**
    ...
    draw_current_edit : function(edit) {
        ...
        bounds = new M.setaskfeedback_editpdf.rect();
        bounds.bound([new M.setaskfeedback_editpdf.point(edit.start.x, edit.start.y),
                      new M.setaskfeedback_editpdf.point(edit.end.x, edit.end.y)]);
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.annotationrectangle = ANNOTATIONRECTANGLE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONOVAL, M.setaskfeedback_editpdf.annotation, {
    /**
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.annotationoval = ANNOTATIONOVAL;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONPEN, M.setaskfeedback_editpdf.annotation, {
    /**
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.annotationpen = ANNOTATIONPEN;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONHIGHLIGHT, M.setaskfeedback_editpdf.annotation, {
    /**
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.annotationhighlight = ANNOTATIONHIGHLIGHT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONSTAMP, M.setaskfeedback_editpdf.annotation, {
    /**
    ...
    draw : function() {
        ...
        position = this.editor.get_window_coordinates(new M.setaskfeedback_editpdf.point(this.x, this.y));
    ...
    draw_current_edit : function(edit) {
        ...
        bounds.bound([edit.start, edit.end]);
        position = this.editor.get_window_coordinates(new M.setaskfeedback_editpdf.point(bounds.x, bounds.y));
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.annotationstamp = ANNOTATIONSTAMP;
...
Y.extend(DROPDOWN, M.core.dialogue, {
    ...
    initializer : function(config) {
        ...
        bb.addClass('setaskfeedback_editpdf_dropdown');
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.dropdown = DROPDOWN;
...
Y.extend(COLOURPICKER, M.setaskfeedback_editpdf.dropdown, {
     ...
     */
    initializer : function(config) {
        var colourlist = Y.Node.create('<ul role="menu" class="setaskfeedback_editpdf_menu"/>'),
            body;
        ...
        Y.each(this.get('colours'), function(rgb, colour) {
            ...
            title = M.util.get_string(colour, 'setaskfeedback_editpdf');
            iconname = this.get('iconprefix') + colour;
            img = M.util.image_url(iconname, 'setaskfeedback_editpdf');
        ...
        this.set('headerText', M.util.get_string('colourpicker', 'setaskfeedback_editpdf'));
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.colourpicker = COLOURPICKER;
...
Y.extend(COMMENTMENU, M.setaskfeedback_editpdf.dropdown, {
    ...
    initializer : function(config) {
        ...
        commentlinks = Y.Node.create('<ul role="menu" class="setaskfeedback_editpdf_menu"/>');

        link = Y.Node.create('<li><a tabindex="-1" href="#">' +
               M.util.get_string('addtoquicklist', 'setaskfeedback_editpdf') +
               '</a></li>');
        ...
        link = Y.Node.create('<li><a tabindex="-1" href="#">' +
               M.util.get_string('deletecomment', 'setaskfeedback_editpdf') +
               '</a></li>');
        ...
        // Set the accessible header text.
        this.set('headerText', M.util.get_string('commentcontextmenu', 'setaskfeedback_editpdf'));
        ...
        Y.each(comment.editor.quicklist.comments, function(quickcomment) {
            var listitem = Y.Node.create('<li class="quicklist_comment"></li>'),
                ...
                deletelinkitem = Y.Node.create('<a href="#" tabindex="-1" class="delete_quicklist_comment">' +
                                               ...
                                               'alt="' + M.util.get_string('deletecomment', 'setaskfeedback_editpdf') + '"/>' +
                                               '</a>');
    ...
    ATTRS : {
         ...
         *
         * @attribute comment
         * @type M.setaskfeedback_editpdf.comment
         * @default null
         */
        comment : {
            value : null
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.commentmenu = COMMENTMENU;
...
COMMENTSEARCH = function(config) {
    ...
    config.width = '400px';
    config.visible = false;
    config.headerContent = M.util.get_string('searchcomments', 'setaskfeedback_editpdf');
    config.footerContent = '';
...
Y.extend(COMMENTSEARCH, M.core.dialogue, {
    ...
    initializer : function(config) {
        ...
        bb = this.get('boundingBox');
        bb.addClass('setaskfeedback_editpdf_commentsearch');

        editor = this.get('editor');
        container = Y.Node.create('<div/>');

        placeholder = M.util.get_string('filter', 'setaskfeedback_editpdf');
        commentfilter = Y.Node.create('<input type="text" size="20" placeholder="' + placeholder + '"/>');
        container.append(commentfilter);
        commentlist = Y.Node.create('<ul role="menu" class="setaskfeedback_editpdf_menu"/>');
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.commentsearch = COMMENTSEARCH;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var COMMENT = function(editor, gradeid, pageno, x, y, width, colour, rawtext) {
     ...
     * @property menu
     * @type M.setaskfeedback_editpdf.dropdown
     * @public
     */
    this.menu = null;
    ...
    this.attach_events = function(node, menu) {
        ...
        node.on('gesturemove', function(e) {
            ...
            newlocation = this.editor.get_canvas_coordinates(new M.setaskfeedback_editpdf.point(x, y));
        ...
        this.menu = new M.setaskfeedback_editpdf.commentmenu({
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.comment = COMMENT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.quickcomment = QUICKCOMMENT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var QUICKCOMMENTLIST = function(editor) {
     ...
     * Array of Comments
     * @property shapes
     * @type M.setaskfeedback_editpdf.quickcomment[]
     * @public
     */
    this.comments = [];
    ...
    this.add = function(comment) {
        ...
        config = {
            ...
            data : {
                ...
                'setaskmentid' : this.editor.get('setaskmentid')
            },
            on: {
                success: function(tid, response) {
                    ...
                    try {
                        ...
                        if (jsondata.error) {
                            ...
                            quickcomment = new M.setaskfeedback_editpdf.quickcomment(jsondata.id,
                                                                                     jsondata.rawtext,
                                                                                     jsondata.width,
                                                                                     jsondata.colour);
                    ...
                    try {
                        ...
                        if (jsondata.error) {
                            ...
                            Y.each(jsondata, function(comment) {
                                var quickcomment = new M.setaskfeedback_editpdf.quickcomment(comment.id,
                                                                                             comment.rawtext,
                                                                                             comment.width,
                                                                                             comment.colour);
                                this.comments.push(quickcomment);
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.quickcommentlist = QUICKCOMMENTLIST;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
EDITOR.prototype = {
     ...
     * @type M.setaskfeedback_editpdf.edit
     * @protected
     */
    currentedit : new M.setaskfeedback_editpdf.edit(),

    /**
     * Current drawable.
     *
     * @property currentdrawable
     * @type M.setaskfeedback_editpdf.drawable|false
     * @protected
     */
     ...
     *
     * @property drawables
     * @type array(M.setaskfeedback_editpdf.drawable)
     * @protected
     */
    drawables : [],
     ...
     * @type M.setaskfeedback_editpdf.annotation
     * @protected
     */
     ...
     * @property quicklist
     * @type M.setaskfeedback_editpdf.quickcommentlist
     * @protected
     */
    quicklist : null,
    ...
    initializer : function() {
        ...
        if (link) {
            ...
            if (!this.get('readonly')) {
                this.quicklist = new M.setaskfeedback_editpdf.quickcommentlist(this);
            }
        }
    },
    ...
    refresh_button_state : function() {
        ...
        imgurl = M.util.image_url('background_colour_' + this.currentedit.commentcolour, 'setaskfeedback_editpdf');
        ...
        imgurl = M.util.image_url('colour_' + this.currentedit.annotationcolour, 'setaskfeedback_editpdf');
        button.one('img').setAttribute('src', imgurl);

        currenttoolnode = Y.one(TOOLSELECTOR[this.currentedit.tool]);
        currenttoolnode.addClass('setaskfeedback_editpdf_selectedbutton');
    ...
    get_canvas_bounds : function() {
        ...
        return new M.setaskfeedback_editpdf.rect(offsetleft, offsettop, width, height);
    },

    /**
     * Called to translate from window coordinates to canvas coordinates.
     * @method get_canvas_coordinates
     * @param M.setaskfeedback_editpdf.point point in window coordinats.
     */
    get_canvas_coordinates : function(point) {
        var bounds = this.get_canvas_bounds(),
            newpoint = new M.setaskfeedback_editpdf.point(point.x - bounds.x, point.y - bounds.y);
    ...
    load_all_pages : function() {
        ...
        config = {
            ...
            data : {
                ...
                setaskmentid : this.get('setaskmentid'),
    ...
    all_pages_loaded : function(responsetext) {
        ...
        try {
            ...
            if (data.error || !data.pagecount) {
                ...
                error = new M.core.alert({ message: M.util.get_string('cannotopenpdf', 'setaskfeedback_editpdf') });
                error.show();
                return;
            }
        } catch (e) {
            this.dialogue.hide();
            // Display alert dialogue.
            error = new M.core.alert({ title: M.util.get_string('cannotopenpdf', 'setaskfeedback_editpdf')});
            error.show();
            return;
        }
        ...
        for (i = 0; i < this.pages.length; i++) {
            for (j = 0; j < this.pages[i].comments.length; j++) {
                ...
                this.pages[i].comments[j] = new M.setaskfeedback_editpdf.comment(this,
                                                                                 comment.gradeid,
                                                                                 comment.pageno,
                                                                                 comment.x,
                                                                                 comment.y,
    ...
    setup_toolbar : function() {
        ...
        picker = new M.setaskfeedback_editpdf.colourpicker({
        ...
        if (stampfiles.length <= 0) {
            ...
            picker = new M.setaskfeedback_editpdf.stamppicker({
    ...
    handle_tool_button : function(e, tool) {
        ...
        currenttoolnode = Y.one(TOOLSELECTOR[this.currentedit.tool]);
        currenttoolnode.removeClass('setaskfeedback_editpdf_selectedbutton');
    ...
    get_current_drawable : function() {
        ...
        if (this.currentedit.tool === 'comment') {
            comment = new M.setaskfeedback_editpdf.comment(this);
    ...
    edit_move : function(e) {
        ...
        var bounds = this.get_canvas_bounds(),
            ...
            clientpoint = new M.setaskfeedback_editpdf.point(e.clientX + canvas.get('docScrollX'),
    ...
    create_annotation : function(type, data) {
        ...
        data.editor = this;
        if (type === "line") {
            return new M.setaskfeedback_editpdf.annotationline(data);
        } else if (type === "rectangle") {
            return new M.setaskfeedback_editpdf.annotationrectangle(data);
        } else if (type === "oval") {
            return new M.setaskfeedback_editpdf.annotationoval(data);
        } else if (type === "pen") {
            return new M.setaskfeedback_editpdf.annotationpen(data);
        } else if (type === "highlight") {
            return new M.setaskfeedback_editpdf.annotationhighlight(data);
        } else if (type === "stamp") {
            return new M.setaskfeedback_editpdf.annotationstamp(data);
        }
        return false;
    },
    ...
    open_search_comments : function(e) {
        if (!this.searchcommentswindow) {
            this.searchcommentswindow = new M.setaskfeedback_editpdf.commentsearch({
                editor : this
            });
        }
    ...
    setup_navigation : function() {
        ...
        if (options.size() <= 1) {
            for (i = 0; i < this.pages.length; i++) {
                ...
                option.setHTML(M.util.get_string('pagenumber', 'setaskfeedback_editpdf', i+1));
...
Y.extend(EDITOR, Y.Base, EDITOR.prototype, {
    NAME : 'moodle-setaskfeedback_editpdf-editor',
    ATTRS : {
        userid : {
...
M.setaskfeedback_editpdf = M.setaskfeedback_editpdf || {};
M.setaskfeedback_editpdf.editor = M.setaskfeedback_editpdf.editor || {};
 ...
 * @param {Object} params
 */
M.setaskfeedback_editpdf.editor.init = M.setaskfeedback_editpdf.editor.init || function(params) {
