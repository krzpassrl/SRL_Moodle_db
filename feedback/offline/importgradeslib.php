 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class setaskfeedback_offline_grade_importer {
    ...
    /** @var setaskment $setaskment - the setaskment class */
    private $setaskment;
     ...
     * @param setask $setaskment The current setaskment
     */
    public function __construct($importid, setask $setaskment) {
