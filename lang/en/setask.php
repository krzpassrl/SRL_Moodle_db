...
/**
 * Strings for component 'setask', language 'en'
 *
 * @package   mod_setask
...
$string['activityoverview'] = 'You have sphere assignments that need attention';
...
$string['allowsubmissions'] = 'Allow the user to continue making submissions to this sphere assignment.';
...
$string['allowsubmissionsfromdatesummary'] = 'This sphere assignment will accept submissions from <strong>{$a}</strong>';
$string['allowsubmissionsanddescriptionfromdatesummary'] = 'The sphere assignment details and submission form will be available from <strong>{$a}</strong>';
$string['alwaysshowdescription'] = 'Always show description';
$string['alwaysshowdescription_help'] = 'If disabled, the Sphere Assignment Description above will only become visible to students at the "Allow submissions from" date.';
$string['applytoteam'] = 'Apply grades and feedback to entire group';
$string['setask:addinstance'] = 'Add a new sphere assignment';
$string['setask:exportownsubmission'] = 'Export own submission';
$string['setask:editothersubmission'] = 'Edit another student\'s submission';
$string['setask:grade'] = 'Grade sphere assignment';
$string['setask:grantextension'] = 'Grant extension';
$string['setask:manageallocations'] = 'Manage markers allocated to submissions';
$string['setask:managegrades'] = 'Review and release grades';
$string['setask:receivegradernotifications'] = 'Receive grader submission notifications';
$string['setask:releasegrades'] = 'Release grades';
$string['setask:revealidentities'] = 'Reveal student identities';
$string['setask:reviewgrades'] = 'Review grades';
$string['setask:viewblinddetails'] = 'View student identities when blind marking is enabled';
$string['setask:viewgrades'] = 'View grades';
$string['setask:submit'] = 'Submit sphere assignment';
$string['setask:view'] = 'View sphere assignment';
$string['setaskfeedback'] = 'Feedback plugin';
$string['setaskfeedbackpluginname'] = 'Feedback plugin';
$string['setaskmentisdue'] = 'Sphere Assignment is due';
$string['setaskmentmail'] = '{$a->grader} has posted some feedback on your
sphere assignment submission for \'{$a->setaskment}\'

You can see it appended to your sphere assignment submission:

    {$a->url}';
$string['setaskmentmailhtml'] = '<p>{$a->grader} has posted some feedback on your
sphere assignment submission for \'<i>{$a->setaskment}</i>\'.</p>
<p>You can see it appended to your <a href="{$a->url}">setaskment submission</a>.</p>';
$string['setaskmentmailsmall'] = '{$a->grader} has posted some feedback on your
sphere assignment submission for \'{$a->setaskment}\' You can see it appended to your submission';
$string['setaskmentname'] = 'Sphere Assignment name';
$string['setaskmentplugins'] = 'Sphere Assignment plugins';
$string['setaskmentsperpage'] = 'Sphere Assignments per page';
$string['setasksubmission'] = 'Submission plugin';
$string['setasksubmissionpluginname'] = 'Submission plugin';
...
$string['backtosetaskment'] = 'Back to sphere assignment';
...
$string['blindmarking_help'] = 'Blind marking hides the identity of students from markers. Blind marking settings will be locked once a submission or grade has been made in relation to this sphere assignment.';
$string['changegradewarning'] = 'This sphere assignment has graded submissions and changing the grade will not automatically re-calculate existing submission grades. You must re-grade all existing submissions, if you wish to change the grade.';
...
$string['conversionexception'] = 'Could not convert sphere assignment. Exception was: {$a}.';
...
$string['couldnotconvertgrade'] = 'Could not convert sphere assignment grade for user {$a}.';
$string['couldnotconvertsubmission'] = 'Could not convert sphere assignment submission for user {$a}.';
$string['couldnotcreatecoursemodule'] = 'Could not create course module.';
$string['couldnotcreatenewsetaskmentinstance'] = 'Could not create new sphere assignment instance.';
$string['couldnotfindsetaskmenttoupgrade'] = 'Could not find old sphere assignment instance to upgrade.';
...
$string['cutoffdate_help'] = 'If set, the sphere assignment will not accept submissions after this date without an extension.';
...
$string['defaultsettings'] = 'Default sphere assignment settings';
$string['defaultsettings_help'] = 'These settings define the defaults for all new sphere assignments.';
...
$string['duedate_help'] = 'This is when the sphere assignment is due. Submissions will still be allowed after this date but any sphere assignments submitted after this date are marked as late. To prevent submissions after a certain date - set the sphere assignment cut off date.';
$string['duedateno'] = 'No due date';
$string['submissionempty'] = 'Nothing was submitted';
$string['duedatereached'] = 'The due date for this sphere assignment has now passed';
...
$string['gradersubmissionupdatedtext'] = '{$a->username} has updated their sphere assignment submission
for \'{$a->setaskment}\' at {$a->timeupdated}

It is available here:

    {$a->url}';
$string['gradersubmissionupdatedhtml'] = '{$a->username} has updated their sphere assignment submission
for <i>\'{$a->setaskment}\'  at {$a->timeupdated}</i><br /><br />
It is <a href="{$a->url}">available on the web site</a>.';
$string['gradersubmissionupdatedsmall'] = '{$a->username} has updated their submission for sphere assignment {$a->setaskment}.';
...
$string['errorquickgradingvsadvancedgrading'] = 'The grades were not saved because this sphere assignment is currently using advanced grading';
...
sphere assignment submission for \'<i>{$a->setaskment}</i>\'<br /><br />
You can see it appended to your <a href="{$a->url}">setaskment submission</a>.';
$string['feedbackavailablesmall'] = '{$a->username} has given feedback for sphere assignment {$a->setaskment}';
...
$string['feedbackpluginforgradebook_help'] = 'Only one sphere assignment feedback plugin can push feedback into the gradebook.';
...
$string['introattachments_help'] = 'Additional files for use in the sphere assignment, such as answer templates, may be added. Download links for the files will then be displayed on the sphere assignment page under the description.';
...
$string['managesetaskfeedbackplugins'] = 'Manage sphere assignment feedback plugins';
$string['managesetasksubmissionplugins'] = 'Manage sphere assignment submission plugins';
...
$string['maxgrade'] = 'Maximum Grade';
$string['messageprovider:setask_notification'] = 'Sphere Assignment notifications';
$string['modulename'] = 'Sphere Assignment';
$string['modulename_help'] = 'The sphere assignment activity module enables a teacher to communicate tasks, collect work and provide grades and feedback.

Students can submit any digital content (files), such as word-processed documents, spreadsheets, images, or audio and video clips. Alternatively, or in addition, the sphere assignment may require students to type text directly into the text editor. An sphere assignment can also be used to remind students of \'real-world\' sphere assignments they need to complete offline, such as art work, and thus not require any digital content. Students can submit work individually or as a member of a group.

When reviewing sphere assignments, teachers can leave feedback comments and upload files, such as marked-up student submissions, documents with comments or spoken audio feedback. Sphere Assignments can be graded using a numerical or custom scale or an advanced grading method such as a rubric. Final grades are recorded in the gradebook.';
$string['modulename_link'] = 'mod/setaskment/view';
$string['modulenameplural'] = 'Sphere Assignments';
$string['moreusers'] = '{$a} more...';
$string['mysubmission'] = 'My submission: ';
$string['newsubmissions'] = 'Sphere Assignments submitted';
...
$string['noonlinesubmissions'] = 'This sphere assignment does not require you to submit anything online';
$string['nosavebutnext'] = 'Next';
$string['nosubmission'] = 'Nothing has been submitted for this sphere assignment';
...
$string['numberofsubmittedsetaskments'] = 'Submitted';
...
$string['overdue'] = '<font color="red">Sphere Assignment is overdue by: {$a}</font>';
$string['outlinegrade'] = 'Grade: {$a}';
$string['page-mod-setask-x'] = 'Any sphere assignment module page';
$string['page-mod-setask-view'] = 'Sphere Assignment module main and submission page';
$string['participant'] = 'Participant';
$string['pluginadministration'] = 'Sphere Assignment administration';
$string['pluginname'] = 'Sphere Assignment';
...
$string['preventsubmissions'] = 'Prevent the user from making any more submissions to this sphere assignment.';
...
$string['quickgrading_help'] = 'Quick grading allows you to setask grades (and outcomes) directly in the submissions table. Quick grading is not compatible with advanced grading and is not recommended when there are multiple markers.';
...
$string['requiresubmissionstatement_help'] = 'Require that students accept the submission statement for all submissions to this sphere assignment.';
$string['requireallteammemberssubmit'] = 'Require all group members submit';
$string['requireallteammemberssubmit_help'] = 'If enabled, all members of the student group must click the submit button for this sphere assignment before the group submission will be considered as submitted. If disabled, the group submission will be considered as submitted as soon as any member of the student group clicks the submit button.';
$string['recordid'] = 'Identifier';
$string['revealidentities'] = 'Reveal student identities';
$string['revealidentitiesconfirm'] = 'Are you sure you want to reveal student identities for this sphere assignment? This operation cannot be undone. Once the student identities have been revealed, the marks will be released to the gradebook.';
...
$string['sendnotifications_help'] = 'If enabled, graders (usually teachers) receive a message whenever a student submits an sphere assignment, early, on time and late. Message methods are configurable.';
$string['selectlink'] = 'Select...';
$string['selectuser'] = 'Select {$a}';
$string['sendlatenotifications'] = 'Notify graders about late submissions';
$string['sendlatenotifications_help'] = 'If enabled, graders (usually teachers) receive a message whenever a student submits an sphere assignment late. Message methods are configurable.';
$string['sendsubmissionreceipts'] = 'Send submission receipt to students';
$string['sendsubmissionreceipts_help'] = 'This switch will enable submission receipts for students. Students will receive a notification every time they successfully submit an sphere assignment';
...
$string['settings'] = 'Sphere Assignment settings';
...
You can see the status of your sphere assignment submission:

    {$a->url}';
$string['submissioncopiedhtml'] = '<p>You have made a copy of your previous
sphere assignment submission for \'<i>{$a->setaskment}</i>\'.</p>
<p>You can see the status of your <a href="{$a->url}">setaskment submission</a>.</p>';
$string['submissioncopiedsmall'] = 'You have copied your previous sphere assignment submission for {$a->setaskment}';
...
$string['submissionnotready'] = 'This sphere assignment is not ready to submit:';
$string['submissionplugins'] = 'Submission plugins';
$string['submissionreceipts'] = 'Send submission receipts';
$string['submissionreceiptothertext'] = 'Your sphere assignment submission for
\'{$a->setaskment}\' has been submitted.

You can see the status of your sphere assignment submission:

    {$a->url}';
$string['submissionreceiptotherhtml'] = 'Your sphere assignment submission for
\'<i>{$a->setaskment}</i>\' has been submitted.<br /><br />
You can see the status of your <a href="{$a->url}">setaskment submission</a>.';
$string['submissionreceiptothersmall'] = 'Your sphere assignment submission for {$a->setaskment} has been submitted.';
...
You can see the status of your sphere assignment submission:
    ...
    {$a->url}';
$string['submissionreceipthtml'] = '<p>You have submitted an sphere assignment submission for \'<i>{$a->setaskment}</i>\'.</p>
<p>You can see the status of your <a href="{$a->url}">setaskment submission</a>.</p>';
$string['submissionreceiptsmall'] = 'You have submitted your sphere assignment submission for {$a->setaskment}';
$string['submissionslocked'] = 'This sphere assignment is not accepting submissions';
...
$string['submissionstatement_help'] = 'Sphere Assignment submission confirmation statement';
$string['submissionstatementdefault'] = 'This sphere assignment is my own work, except where I have acknowledged the use of the works of other people.';
...
$string['submitsetaskment_help'] = 'Once this sphere assignment is submitted you will not be able to make any more changes.';
$string['submitsetaskment'] = 'Submit sphere assignment';
$string['submittedearly'] = 'Sphere Assignment was submitted {$a} early';
$string['submittedlate'] = 'Sphere Assignment was submitted {$a} late';
$string['submittedlateshort'] = '{$a} late';
$string['submitted'] = 'Submitted';
$string['subplugintype_setasksubmission'] = 'Submission plugin';
$string['subplugintype_setasksubmission_plural'] = 'Submission plugins';
$string['subplugintype_setaskfeedback'] = 'Feedback plugin';
$string['subplugintype_setaskfeedback_plural'] = 'Feedback plugins';
...
$string['teamsubmissiongroupingid_help'] = 'This is the grouping that the sphere assignment will use to find groups for student groups. If not set - the default set of groups will be used.';
$string['textinstructions'] = 'Sphere Assignment instructions';
$string['timemodified'] = 'Last modified';
$string['timeremaining'] = 'Time remaining';
$string['ungroupedusers'] = 'The setting \'Require group to make submission\' is turned on and some users are not allocated to groups, this will prevent them from submitting sphere assignments.';
...
$string['viewownsubmissionform'] = 'View own submit sphere assignment page.';
